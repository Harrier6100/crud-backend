...
router.get('/', async (req, res, next) => {
    try {
        const field = req.query.field ? snakecase(req.query.field) : '*, sum(transaction_net_qty) over (partition by stock_id order by transaction_id) as transaction_net_qty';
